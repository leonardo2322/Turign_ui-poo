...
botones_navegacion = [
    ...
    {"icon":icons.STACKED_BAR_CHART, "selected_icon": icons.STACKED_BAR_CHART_OUTLINED, "label": "Estadistica y    opciones"},
...
colors_for_charts = {
      ...
      "5":Colors.AMBER_400,
      "6":Colors.DEEP_ORANGE_200,
      "7":Colors.BROWN_400,
      "8":Colors.LIME_ACCENT_100,
      "9":Colors.GREY,
      "other":Colors.WHITE
}
